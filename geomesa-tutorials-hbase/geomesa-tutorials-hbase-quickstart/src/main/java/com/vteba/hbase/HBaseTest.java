...
public class HBaseTest {
    ...
    public static void init() {
        ...
        try {
            ...
            boolean success = bin.mkdirs();
            System.out.println("创建bin目录：" + success);
            File winUtils = new File("./bin/winutils.exe");
            success = winUtils.createNewFile();
            System.out.println("创建winutils.exe：" + success);
        } catch (IOException e) {
